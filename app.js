var susersToHideFromDEBE = new Set();

fetch('https://eksisozluk.com/takip-engellenmis')
    .then(r => r.text())
    .then(result => {
        ...
        for (let e of blockedThreadsList) susersToHideFromDEBE.add(e.getElementsByTagName("a")[2].getAttribute("data-nick"));
    })
    .then(() => {
